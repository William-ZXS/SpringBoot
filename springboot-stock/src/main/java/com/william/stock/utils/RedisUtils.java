...
public class RedisUtils {
    ...
    public Cursor<Map.Entry<Object, Object>> hScan(String key, ScanOptions options) {
        return (Cursor<Map.Entry<Object, Object>>) redisTemplate.opsForHash().scan(key, options);
    }
    ...
    public Cursor<String> sScan(String key, ScanOptions options) {
        return (Cursor<String>) redisTemplate.opsForSet().scan(key, options);
    }
    ...
    public Cursor<ZSetOperations.TypedTuple<String>> zScan(String key, ScanOptions options) {
        return (Cursor<ZSetOperations.TypedTuple<String>>) redisTemplate.opsForZSet().scan(key, options);
    }
}